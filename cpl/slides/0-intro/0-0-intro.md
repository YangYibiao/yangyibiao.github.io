...
<!--
  ===== 每学期更新清单 =====
  1. 「课程安排」页: 星期几、每次几节 (若课表变化)
  2. 「本学期日历」页: 放假 / 调休 / 考试周日期 (必改)
  3. 「考核方式」页: 三档比例、教案与课程网址
  4. 「在线评测系统」页: OJ 地址 (若平台更换)
  5. 「课程教材」页: 教材版本 (若课程组更换教材)
  6. 「课前小调查」页: 视需要调整问题
  7. 群号/二维码已移除; 如需建群, 补幻灯并在第一次课后删除
-->
