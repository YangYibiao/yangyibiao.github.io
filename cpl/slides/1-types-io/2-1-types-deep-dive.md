...
- ==规范化==: 正常数都存成 $1.xxx \times 2^e$ (==xxx 是 23 位 0/1==)——开头的 1 是必然的, ==隐含不存==, 白赚一位精度
...
| (1/4, 1/2), (1/8, 1/4), … | $1.xxx \times 2^{e}$, 一直对半切到 $2^{-126}$ | -2, -3, …, -126 |
| (0, $2^{-126}$) | $0.xxx \times 2^{-126}$ (非规格化数) | 固定 -126 |
